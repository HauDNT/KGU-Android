...
- Các công nghệ được sử dụng:
    ...
    - Android >= 7.0
### Các yêu cầu chính
- Chức năng 1: Đăng nhập cho người dùng nhập tài khoản và mật khẩu. Nếu người dùng nhập đúng thì cho vào danh sách "Đơn đặt hàng". Nếu người dùng nhập sai thông báo “Thông tin đăng nhập không đúng vui lòng nhập lại!”
- Chức năng 2: Đăng ký tài khoản. Kiểm tra tài khoản đã tồn tại không cho phép đăng ký nữa.
- Chức năng 3: Thêm/Sửa/Xóa và hiển thị danh sách loại sản phẩm: bao gồm thuộc tính mã loại sản phẩm, tên sản phẩm.
- Chức năng 4: Thêm/Sửa/Xóa và hiển thị danh sách sản phẩm: bao gồm thuộc tính mã sản phẩm, tên sản phẩm, loại sản phẩm(lấy từ danh sách loại sản phẩm), đơn giá, mô tả…
